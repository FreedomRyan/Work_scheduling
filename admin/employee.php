	...
	<body>
		...
		<div class="container-fluid admin" >
			...
			<div class="well col-lg-12">
				<button type="button" class="btn btn-success" id="new_emp_btn"><i class="fa fa-plus"></i> Add new </button>
				<br />
				<br />
					...
					<div class="modal-content">
						...
						<form id='employee_frm'>
							...
							<div class="modal-footer">
								<button  class="btn btn-primary" id="employee_frm" name="save"><span class="glyphicon glyphicon-save"></span> Save</button>
							</div>
						</form>
					</div>
				</div>
